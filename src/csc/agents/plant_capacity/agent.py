"""Plant Capacity Agent: validates supply plan against pilot plant manufacturing capacity."""
...
from csc.agents.plant_capacity.prompts import SYSTEM_PROMPT
from csc.agents.plant_capacity.tools import create_tool_handlers, get_tool_definitions
from csc.models import PlantCapacityPlan


class PlantCapacityAgent(BaseAgent):
    @property
